...
The gRPC experiment lasted one week. That's a story for [Log 0x03: The Pivot](./2025-12-23-log-0x03-nexus-restart.md) — where I realized Python's memory model was the real enemy.
